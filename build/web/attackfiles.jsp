  ...
  <div id="content">
	<div id="right">
		...
		<div class="left_top"></div>
                <center><h1 style="color: red;font-family:Castellar;font-size: 25px">ATTACK_DETAILS</h1></center>
		<div id="text">
                    ...
                    <div >
                        <table class="table-fill" >
                            <thead>
        <tr><th class="text-left" >USERID</th><th class="text-left" >USERNAME</th><th class="text-left" >ATTACK_FILE</th></tr>
                            </thead>
    ...
    Statement st = con.createStatement();
        ...
        <tbody class="table-hover">  
            ...
            <td class="text-left" style="color:red" ><%=attackname%></td>
            <td class="text-left" style="color:red" ><textarea style="width:300px;height:50px;overflow: auto"><%=attackfile%></textarea></td>
