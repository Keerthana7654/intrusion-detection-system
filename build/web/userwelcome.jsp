	...
	<div id="buttons">
		...
		<ul>
			<li><a href="index.jsp" title="" class="active">Home</a></li>
                        <li><a href="userupload.jsp" title="">FILEUPLOAD</a></li>
			<li><a href="attack.jsp" title="">USER</a></li>
	...
	<div id="right">
		...
		<ul>
			<li><a href="index.jsp">HOME</a></li>
                        <li><a href="userupload.jsp">FILE_UPLOAD</a></li>
