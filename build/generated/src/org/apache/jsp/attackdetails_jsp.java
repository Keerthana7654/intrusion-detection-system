...
public final class attackdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <center><h1 style=\"color: red;font-family:Castellar;font-size: 25px\"></h1></center>\n");
      ...
      out.write("                            <thead>\n");
      out.write("        <tr><th class=\"text-left\" >USERID</th><th class=\"text-left\" >USERNAME</th><th class=\"text-left\" >ATTACK_LEVEL</th><th class=\"text-left\" >COUNT</th></tr>\n");
      out.write("                            </thead>\n");
      out.write("                           \n");
      out.write("        \n");
      out.write("        ");
    ...
    Statement st = con.createStatement();
         ResultSet rs = st.executeQuery("select * from userreg ");
                       while (rs.next()) {
                           ...
                           String username =rs.getString("username");
                            String attackuser=rs.getString("attackuser");
                           String attackcount =rs.getString("attackcount");
      ...
      out.write("</td>\n");
      out.write("           <td class=\"text-left\" style=\"color:red\" >");
      out.print(attackuser);
      out.write("</td>\n");
      out.write("           <td class=\"text-left\" style=\"color:red\" >");
      out.print(attackcount);
      out.write("</td>\n");
      out.write("            \n");
      out.write("                    \n");
      out.write("                    \n");
