  ...
  <div id="content">
	<div id="right">
		...
		<div class="left_top"></div>
                <center><h1 style="color: red;font-family:Castellar;font-size: 25px">FILE_DETAILS</h1></center>
		<div id="text">
                    ...
                    <div >
                        <table class="table-fill" >
                            <thead>
        <tr><th class="text-left" >FILE_ID</th><th class="text-left" >FILE_NAME</th><th class="text-left" >FILE_DESCRIP</th></tr>
                            </thead>
    ...
    Statement st = con.createStatement();
         ResultSet rs = st.executeQuery("select * from userfle  ");
                       while (rs.next()) {
                           String fileid=rs.getString("fileid");
                           String filename =rs.getString("filename");
                            String filetyp=rs.getString("filetyp");
        ...
        <tbody class="table-hover">  
            ...
            <tr><td class="text-left" style="color:red" ><%=fileid%></td>
            <td class="text-left" style="color:red" ><%=filename%></td>
            <td class="text-left" style="color:red" ><%=filetyp%></textarea></td>
